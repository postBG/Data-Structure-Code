...
class GraphOfStation{
	...
	private Hashtable<String, Station> CodeTable;//코드명으로 정렬할 때 이용
	private Hashtable<String, ArrayList<Station>> NameTable;//이름으로 정렬할 때 이용 
	...
	public Station SearchStationByName(String Name){
		//BinarySearch이용	
		return NameTable.get(Name).get(0);
	}
