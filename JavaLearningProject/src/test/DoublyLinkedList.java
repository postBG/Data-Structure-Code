...
public class DoublyLinkedList {
	...
	public static void main(String[] args) {
		...
		list.pushOrdered("Action", "BATMAN");
		list.pushOrdered("SF", "CONTACT");
		list.pushOrdered("Action", "SPIDERMAN");
		list.pushOrdered("Action", "Killer");
		list.pushOrdered("SF", "MAN IN BALCK");
		list.pushOrdered("Romance", "Notebook");
		list.pushOrdered("Action", "Terminatior");
		list.pushOrdered("Romance", "Lucky one");
		
		list.PrintList();
		System.out.println();
		
		list.erase("Action", "BATMAN");
		list.PrintList();
		System.out.println();
		list.erase("Act", "hello");
		list.erase("Romance", "Note");
		list.erase("Action", "SPIDERMAN");
		list.PrintList();
		System.out.println();
		list.erase("Action", "Killer");
		list.PrintList();
		System.out.println();
		list.erase("Action", "Terminatior");
		list.PrintList();
		System.out.println();
		
		list.pushOrdered("SF", "Oblibian");
		list.pushOrdered("Horro", "Shining");
		list.pushOrdered("Horro", "BAD GUYS");
		
		list.PrintList();
		System.out.println();
		
		list.erase("Romance", "Lucky one");
		list.erase("Romance", "Notebook");
		list.PrintList();
		
		System.out.println();
		list.SearchAndPrint("BA");
		list.SearchAndPrint("KKK");
	}
...
class GenreLinkedList{
	...
	public Boolean isExistGenre(String TargetGenre){
		...
		while(iter!=tail && iter.Genre!=TargetGenre)
			iter=iter.next;
